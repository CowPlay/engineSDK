...
#ifndef IMESH_BUFFER_H_INCLUDED__
#define IMESH_BUFFER_H_INCLUDED__
...
namespace irrgame
{
	namespace scene
	{
		//! Interface for holding a mesh with a single material.
		...
		class IMeshBuffer: public virtual IReferenceCounted
		{
			public:
				...
				virtual video::EVertexType getVertexType() const = 0;
				...
				/** \param box User defined axis aligned bounding box to use
				 for this buffer. */
				virtual void setBoundingBox(const aabbox3df& value) = 0;
				...
				//				virtual  vector3df& getPosition(u32 i) const = 0;
				//
				//				//! returns position of vertex i
				//				virtual vector3df& getPosition(u32 i) = 0;
				//
				//				//! returns normal of vertex i
				//				virtual const vector3df& getNormal(u32 i) const = 0;
				//
				//				//! returns normal of vertex i
				//				virtual vector3df& getNormal(u32 i) = 0;
				//
				//				//! returns texture coord of vertex i
				//				virtual const vector2df& getTCoords(u32 i) const = 0;
				//
				//				//! returns texture coord of vertex i
				//				virtual vector2df& getTCoords(u32 i) = 0;
				//
				...
				//						const u16* const indices, u32 numIndices) = 0;
				//
		...
		//! Return pointer to standard meshbuffer. Internal function. Please do not use.
		IMeshBuffer* createMeshBuffer();

		//! Return pointer to meshbuffer with two texture coords per vertex, e.g. for lightmaps. Internal function. Please do not use.
		IMeshBuffer* createMeshBufferLightMap();

		//! Return pointer to meshbuffer with vertices having tangents stored, e.g. for normal mapping. Internal function. Please do not use.
